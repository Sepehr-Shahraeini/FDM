...
app.factory('flightBagService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _epGetASRByFlight = function (flightId) {
        ...
        $http.get(serviceBase2 + 'api/asr/flight/' + flightId /*+ '?from=' + _df + '&to=' + _dt*/).then(function (response) {
            deferred.resolve(response.data)
        });
    ...
    var _epGetOFPByFlight = function (flightId) {
        ...
        $http.get(serviceBase2 + 'api/ofp/unauthorize/flight/' + flightId).then(function (response) {
            deferred.resolve(response)
        });
    ...
    var _epGetVRByFlight = function (flightId) {
        var deferred = $q.defer();
        $http.get(serviceBase2 + 'api/voyage/flight/' + flightId /*+ '?from=' + _df + '&to=' + _dt*/).then(function (response) {
            deferred.resolve(response)
        });
