'use strict';
app.controller('fdmDashboardBoeing', ['$http', '$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'fdmService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', function ($http, $scope, $location, $routeParams, $rootScope, flightService, fdmService, aircraftService, authService, notificationService, $route, $window) {
    ...
    $scope.bind = function () {
        ...
        fdmService.getFdmEventsName($scope.ymf + 1, $scope.ymt + 1, "b").then(function (response) {
        ...
        fdmService.getEvetnByRegMonthly($scope.ymf + 1, $scope.ymt + 1, "b").then(function (response) {
            $scope.registerEventData = response.Data.data;
        }, function (err) { $scope.loadingVisible = false; General.ShowNotify(err.message, 'error'); });

        fdmService.getTopCpt($scope.ymf + 1, $scope.ymt + 1, "b").then(function (response) {
            $scope.TopCpt = response.Data;
        }, function (err) { $scope.loadingVisible = false; General.ShowNotify(err.message, 'error'); });

        fdmService.compareTopCpt($scope.ymf + 1, $scope.ymt + 1, "b").then(function (response) {
        ...
        fdmService.compareTopRegister($scope.ymf + 1, $scope.ymt + 1, "b").then(function (response) {
        ...
        fdmService.getEventsDaily($scope.ymf + 1, $scope.ymt + 1, "b").then(function (response) {
        ...
        fdmService.fdmDashboardMonthly($scope.yt, $scope.mt + 1, "b").then(function (response) {
        ...
        fdmService.FDMRoute($scope.ymf + 1, $scope.ymt + 1, "b").then(function (response) {
